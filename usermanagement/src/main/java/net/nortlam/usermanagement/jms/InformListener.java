package net.nortlam.usermanagement.jms;
...
public class InformListener implements MessageListener {

    private static final Logger LOG = Logger.getLogger(InformListener.class.getName());
